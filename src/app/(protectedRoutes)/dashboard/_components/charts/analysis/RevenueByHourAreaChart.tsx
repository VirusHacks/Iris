    ...
    return (
      <Card className="bg-[#0a0a0a] border border-gray-800">
        <CardHeader className="border-b border-gray-800">
          <CardTitle className="text-lg font-semibold text-white">Revenue by Hour of Day</CardTitle>
          <CardDescription className="text-gray-400 text-sm">Peak shopping hours</CardDescription>
        </CardHeader>
