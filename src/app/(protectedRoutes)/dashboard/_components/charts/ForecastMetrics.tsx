  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{metrics.mape?.toFixed(2) || "N/A"}%</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">${metrics.mae?.toFixed(0) || "N/A"}</div>
          <p className="text-xs text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">${metrics.rmse?.toFixed(0) || "N/A"}</div>
          <p className="text-xs text-muted-foreground">
