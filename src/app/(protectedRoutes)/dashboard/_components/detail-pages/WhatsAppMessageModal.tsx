  ...
  const generateMessage = async () => {
    ...
    try {
      ...
      if (result.success && result.message) {
        ...
        throw new Error("Invalid response from message generation");
      }
    } catch (error: any) {
      ...
      setMessage(
        `Hello! We have an exciting offer tailored just for you. As a valued customer in our ${segmentCategory} segment, we'd love to share something special. Would you like to learn more?`
      );
    } finally {
